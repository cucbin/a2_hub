...
function SearchBar({
  ...
  useEffect(() => {
    const activeItem = document.querySelector(".gitttree-result-active");
    if (activeItem) {
  ...
  return (
    <Fragment>
      ...
      />
      <div className="gitttree-search">
        <div className="gitttree-searchbar">
          <input
            type="text"
            value={searchFor}
        ...
        <div
          className={
            resultsLoading <= 0
              ? "gitttree-search-results"
              : "gitttree-search-results  gitttree-results-loading"
          }
        >
        ...
        <div className="gitttree-search-help">
          <span className="gitttree-search-help-item">
            <code>
              {isMac ? (
                <span className="gitttree-search-help-item-icon">⌘</span>
              ) : (
                "Ctrl"
              )}{" "}
              + P
